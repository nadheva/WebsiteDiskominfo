...
<x-guest-layout>
        ...
        <div class="container"> <!-- container -->
            <div class="section-header">
                <h2>Strategi Gresik  <span class="highlight"><strong>Smart City</strong></span></h2>
            </div>
        </div>
        <!-- ======= About Section ======= -->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-3">
                      <div class="list-group" id="list-tab" role="tablist">
                        <a class="list-group-item list-group-item-action active" id="list-home-list" data-bs-toggle="list" href="#list-home" role="tab" aria-controls="list-home">SMART GOVERNANCE</a>
                        <a class="list-group-item list-group-item-action" id="list-profile-list" data-bs-toggle="list" href="#list-profile" role="tab" aria-controls="list-profile">SMART BRANDING</a>
                        <a class="list-group-item list-group-item-action" id="list-messages-list" data-bs-toggle="list" href="#list-messages" role="tab" aria-controls="list-messages">SMART ECONOMY</a>
                        <a class="list-group-item list-group-item-action" id="list-settings-list" data-bs-toggle="list" href="#list-settings" role="tab" aria-controls="list-settings">SMART SOCIETY</a>
                        <a class="list-group-item list-group-item-action" id="list-settings-list" data-bs-toggle="list" href="#list-settings" role="tab" aria-controls="list-settings">SMART LIVING</a>
                        <a class="list-group-item list-group-item-action" id="list-settings-list" data-bs-toggle="list" href="#list-settings" role="tab" aria-controls="list-settings">SMART ENVIRONMENT</a>
                      </div>
                    </div>
                    <div class="col-9">
                      <div class="tab-content" id="nav-tabContent">
                        ...
                        <div class="tab-pane fade" id="list-messages" role="tabpanel" aria-labelledby="list-messages-list">5</div>
                        <div class="tab-pane fade" id="list-settings" role="tabpanel" aria-labelledby="list-settings-list">6    </div>
                      </div>
                    </div>
                  </div>
                ...
                {{-- <div class="row content">
                    <div class="col-lg-6" data-aos="fade-right" data-aos-delay="100">
                        ...
                        <h3>{{$DISKOMINFO->struktur_organisasi}}</h3>
                    </div>
            ...
            <div class="row">
                ...
                <div class="testimonials-slider swiper-container" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="swiper-slide">
                        ...
                        <img src="Bethany/assets/img/testimonials/testimonials-2.jpg" class="testimonial-img" alt="">
                        <h3>Sara Wilsson</h3>
                        <h4>Designer</h4>
                        </div>
                    </div><!-- End testimonial item -->
                    ...
                    <div class="swiper-slide">
                        ...
                        <img src="Bethany/assets/img/testimonials/testimonials-3.jpg" class="testimonial-img" alt="">
                        <h3>Jena Karlis</h3>
                        <h4>Store Owner</h4>
                        </div>
                    </div><!-- End testimonial item -->
                    ...
                    <div class="swiper-slide">
                        ...
                        <img src="Bethany/assets/img/testimonials/testimonials-4.jpg" class="testimonial-img" alt="">
                        <h3>Matt Brandon</h3>
                        <h4>Freelancer</h4>
                        </div>
                    </div><!-- End testimonial item -->
                    ...
                    <div class="swiper-slide">
                        ...
                        <img src="Bethany/assets/img/testimonials/testimonials-5.jpg" class="testimonial-img" alt="">
                        <h3>John Larson</h3>
                        <h4>Entrepreneur</h4>
                        </div>
                    </div><!-- End testimonial item -->
